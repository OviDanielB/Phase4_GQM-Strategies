...
import com.gqm3242.controller.ValidationOpService;
...
import com.gqm3242.model.rest.response.*;
import com.gqm3242.repositories.CollectedDataRepository;
import com.gqm3242.repositories.ValidationOpRepository;
import com.gqm3242.repositories.gqm3141.MeasureTaskRepository;
import com.gqm3242.repositories.gqm3141.WorkflowDataRepository;
import com.gqm3242.utils.ValidationPhase4;
...
public class ValidationOpServiceImpl implements ValidationOpService {
	...
	public ResponseEntity<?> repeateMeasure(
		...
		@SuppressWarnings("unused")
		ActivitiTaskVariable activitiTaskVariable1 = 
				activitiInterationImplementation.updateActivitiTaskVariable(
		...
		@SuppressWarnings("unused")
		ActivitiTaskVariable activitiTaskVariable2 = 
				activitiInterationImplementation.updateActivitiTaskVariable(
		...
		List<ActivitiTaskVariable> taskVarList =
		...
		ActivitiTaskVariable error = new ActivitiTaskVariable();
		...
		activitiTaskVariables.add(error);
		
		ActivitiTaskVariable idData = new ActivitiTaskVariable();
		...
		List<ActivitiTaskVariable> activitiTaskVariableList = 
				activitiInterationImplementation.getTaskVariablesFromRuntimeTaskId(
						idRuntimeTask, "local");
		for(ActivitiTaskVariable variable : 
			activitiTaskVariableList ){
	...
	@Override
	public ResponseEntity<?> completeValidation(String taskId) throws AnomalySystemException{
		/**
