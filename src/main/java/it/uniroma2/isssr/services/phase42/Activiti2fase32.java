...
import it.uniroma2.isssr.model.phase42.activiti.process.ActivitiProcessDefinition;
import it.uniroma2.isssr.model.phase42.activiti.process.ActivitiProcessInvolvedPeople;
...
public interface Activiti2fase32 {
	...
	public void createTaskVariables(String taskId, List<TaskVariable> taskVariables);
