...
import it.uniroma2.isssr.model.phase42.rest.response.activiti.DTOResponseActivitiTaskVariables;
...
public class ActivitiTaskServiceImplementation implements ActivitiTaskService {
	...
	public ResponseEntity<?> getTaskVariablesFromRuntimeTaskId(
		...
		// TODO Auto-generated method stub
			...
			for(TaskVariable taskVariable : taskVariables){
				...
				dtoResponseActivitiTaskVariable.setName(taskVariable.getName());
				dtoResponseActivitiTaskVariable.setScope(taskVariable.getScope());
				dtoResponseActivitiTaskVariable.setType(taskVariable.getType());
				dtoResponseActivitiTaskVariable.setValue(taskVariable.getValue());
	...
	public ResponseEntity<?> createTaskVariableFromRuntimeTaskId(
		...
		List<DTOResponseActivitiTaskVariables> dtoResponseActivitiTaskVariables = 
				new ArrayList<DTOResponseActivitiTaskVariables>();
		actitiviInterationImplementation.createTaskVariableFromRuntimeTaskId(taskId, taskVariables);
		for(TaskVariable taskVariable : taskVariables){
	...
	public ResponseEntity<?> completeUserTasksWithStoredVariables(
		...
		// TODO Auto-generated method stub
		List<TaskVariable> taskVariablesGlobal =
				actitiviInterationImplementation.getTaskVariablesFromRuntimeTaskId(
				taskId, "global");
		List<TaskVariable> taskVariablesLocal =
				actitiviInterationImplementation.getTaskVariablesFromRuntimeTaskId(
				taskId, "local");
		...
		for(TaskVariable taskVariableGlobal:taskVariablesGlobal){
			DTOResponseActivitiTaskVariables dtoResponseActivitiTaskVariable
						= new DTOResponseActivitiTaskVariables();
		...
		for(TaskVariable taskVariableLocal:taskVariablesLocal){
			DTOResponseActivitiTaskVariables dtoResponseActivitiTaskVariable
						= new DTOResponseActivitiTaskVariables();
