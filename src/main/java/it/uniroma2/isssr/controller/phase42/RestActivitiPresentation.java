...
import it.uniroma2.isssr.model.phase42.rest.DTOUpdateActivitiTask;
...
import it.uniroma2.isssr.services.phase42.*;
...
public class RestActivitiPresentation {
	 ...
	 * 
	 * @param taskId: id runtime dello User Task in Activiti
	 * @param taskVariables: il body della post, ovvero una list di task
	 * 		variables.
	 * @return
	 * @throws JsonParseException
	 * @throws JsonMappingException
	...
	@RequestMapping(value = "/taskVariables/{taskId}",
	  ...
	  public ResponseEntity<?> createTaskVariableFromRuntimeTaskId(
			  @PathVariable("taskId") String taskId,
			  @RequestBody List<TaskVariable> taskVariables)//DTOActivitiTaskVariables dtoActivitiTaskVariables)
	 ...
	 * body non sono presenti TaskVariable, ma ActivitiFormVariableProperty )
	 * 
