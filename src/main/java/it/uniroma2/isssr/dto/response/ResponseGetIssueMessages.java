...
public class ResponseGetIssueMessages {

	@JsonProperty("businessWorkflowName")
	...
	/**
	 * 
	 * @return The businessWorkflowName
	 */
	@JsonProperty("businessWorkflowName")
	...
	/**
	 * 
	 * @param businessWorkflowName
	 *            The businessWorkflowName
	 */
	@JsonProperty("businessWorkflowName")
